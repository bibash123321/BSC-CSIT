...
int main() {
    ...
    printf("| %3d  |  ε    |  q0   |    %c     | Move to q1      | ", step++, stack[top]);
    for (int j = 0; j <= top; j++) printf("%c", stack[j]);
    printf(" |\n");
    ...
    printf("--------------------------------------------------------------------------\n");
    if (stack[top] == 'Z') {
        printf("Action: ε, Move to qf (Final State)\n");
        printf("\n✅ Accepted: String is of the form W Wᴿ (Palindrome).\n");
    } else {
